...
frc2::CommandPtr Sequences::RunHubShooterSystem(Shooter *m_shooter, Turret *m_turret, Indexer *m_indexer) {
...
frc2::CommandPtr Sequences::RunPassShooterSystem(Shooter *m_shooter, Turret *m_turret, Indexer *m_indexer) {
